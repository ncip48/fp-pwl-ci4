...
class Fpdf
{
	...
	protected $footer_qrcode;      // qrcode in footer
	protected $enable_footer_qrcode; // enable qrcode in footer
	...
	function __construct($orientation = 'P', $unit = 'mm', $size = 'A4')
	{
		...
		$this->enable_footer_qrcode = false;
		$this->footer_qrcode = '';
		$this->state = 0;
		$this->page = 0;
		$this->n = 2;
	...
	function EnableFooterQrcode($enable = true)
	{
		$this->enable_footer_qrcode = $enable;
	}

	function SetFooterQrcode($qrcode)
	{
		$this->footer_qrcode = $qrcode;
	}
	...
	function Footer()
	{
		...
		if ($this->enable_footer_qrcode) {
			//define height and width of documents
			$height = 297;
			$width = 210;
			//place qrcode in the bottom right corner

			//add some text
			$this->SetY(-15);
			$this->SetX(10);
			$this->Cell(0, 10, '*Dokumen ini tidak memerlukan tanda tangan basah dikarenakan telah di tanda tangani secara elektronik', 0, 0, 'L');

			$this->Image($this->footer_qrcode, $width - 30, $height - 30, 25, 25, 'PNG');
			// $this->Image($this->footer_qrcode, 50, 10, 30, 30, 'PNG');
		}
	}
